...
def run_with_threads(tur, log, main_turtle):
    ...
    # Define the functions for each thread
    ...
    # Create the threads
    thread1 = threading.Thread(target=draw_squares_thread)
    thread2 = threading.Thread(target=draw_circles_thread)
    thread3 = threading.Thread(target=draw_triangles_thread)
    thread4 = threading.Thread(target=draw_rectangles_thread)
